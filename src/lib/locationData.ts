...
export const COUNTRIES = [
  ...
  { code: 'OTHER', name: 'Diğer (Elle Giriş)' },
] as const;
...
export const DISTRICTS_BY_CITY_TR: Record<string, readonly string[]> = {
  ...
  // Add more cities and districts as needed or use a more comprehensive data source
};
